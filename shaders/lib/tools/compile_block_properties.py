...
block_properties_str = '# Don\'t edit this by hand, it\'s automatically generated by the script `compile_block_properties.py` (and `blocks.yml`).\n'
block_aliases_str = '// Don\'t edit this by hand, it\'s automatically generated by the script `compile_block_properties.py` (and `blocks.yml`).\n\n'
