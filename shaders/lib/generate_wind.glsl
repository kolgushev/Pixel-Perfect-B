...
vec2 getCalmWindProfile(in vec2 position, in float time) {
...
vec2 getStormyWindProfile(in vec2 position, in float time) {
	#if defined DIM_OVERWORLD
		return 
			...
			windImpulse(0.95 * 1.4, 0.41 * 0.25 + 0.5, 0.541, 0.84, 6.0, position, time) +
			windImpulse(0.82 * 1.4, 0.67 * 0.25 + 0.5, 0.214, 0.93, 6.0, position, time) +
			windImpulse(0.50 * 1.4, 0.30 * 0.25 + 0.5, 0.113, 0.59, 6.0, position, time) +
			windImpulse(0.40 * 1.4, 0.85 * 0.25 + 0.5, 0.212, 0.43, 6.0, position, time)
			;
	#else
		return vec2(0, 0);
	#endif
